...
document.getElementById('nextOtp').addEventListener('click',function(){
    if(tester == 1){
        ...
        $.ajax({
             ...
             type: 'POST',
            url:'http://localhost/wheelcare/updateshop.php',
            async:false,
            data:{fname: name, lname: lname,address: address, contact: contact, sname: sname, servicetype: servicetype, vehicletype: vehicletype, latitude: latitude, longitude: longi, tcontact: tcontact, opentime: opentime, closetime: closetime,shopid: shopid},
